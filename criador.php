          ...
          <div class="col-lg-12" data-aos="fade-up" data-aos-delay="300">
            <form action="processar.php" method="post" class="email-form">
              <div class="form-row">
                ...
                <div class="col-lg-6 form-group">
                    RG <input type="text" name="nm_rg" class="form-control" id="nm_rg" placeholder="Digite o RG" data-rule="minlen:4" data-msg="" onfocusout="validar(this);" onkeyup="validar(this);" value="<?php echo $nm_rg; ?>"/> 
                  <div class="validate"></div>
                </div>
                <div class="col-lg-6 form-group">
